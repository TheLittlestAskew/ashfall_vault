...
> In-character POV journal. Strictly in-world: no OOC, no player names, no mechanics, no campaign references. Memoir title TBD (⚑ voice guide not yet drafted — entries until then are grounded/neutral voice).

---

> [!note]- S01 — Two nights before Christmas (Graduation Day)
...
> [!note]- S02 — The morning after (Ashes of the Living)
> **The morning after.**
>
