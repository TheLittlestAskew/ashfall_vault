...
|---|---|---|---|---|---|---|
| Taylor (DM) | 12 | 6 | 2 | 5 | 0 | **25** |
| Chase (Valerian) | 10 | 6 | 5 | 0 | 3 | **24** |
| Taylor (Vega) | 6 | 4 | 1 | 2 | 1 | **14** |
| Josh (Samothy) | 3 | 2 | 0 | 7 | 0 | **12** |
| Madi (Deanna) | 2 | 1 | 1 | 0 | 0 | **4** |
| Christie (Zelda) | 1 | 0 | 0 | 2 | 0 | **3** |
| Doug (Barrett) | 0 | 1 | 0 | 0 | 0 | **1** |
...
## S05 — The Bell of Saint Ardas (03/24/2026) *(backfilled 06/06/2026)*

> Note: from S05 on, OOC blocks are indexed but not removed — counts include table chatter.

| Speaker | fuck | shit | bitch | damn/goddamn | motherfucker | Session Total |
|---|---|---|---|---|---|---|
| Chase (Valerian) | 13 | 3 | 0 | 0 | 0 | **16** |
| Taylor (Vega) | 11 | 5 | 0 | 0 | 0 | **16** |
| Madi (Deanna) | 1 | 2 | 0 | 1 | 0 | **4** |
| Josh (Samothy) | 2 | 0 | 0 | 1 | 0 | **3** |
| Christie (Zelda) | 2 | 1 | 0 | 0 | 0 | **3** |
| Taylor (DM) | 1 | 1 | 0 | 0 | 0 | **2** |
| Doug (Barrett) | 0 | 0 | 0 | 1 | 0 | **1** |
| *Unattributed (E-blob)* | *5* | *0* | *0* | *2* | *0* | *(7)* |

**Session champions (tie):** Chase & Taylor, 16 each — a roleplay session keeps it civil.

## S06 — Protect the Light (04/01/2026) *(backfilled 06/06/2026)*

| Speaker | fuck | shit | bitch | damn/goddamn | motherfucker | Session Total |
|---|---|---|---|---|---|---|
| Taylor (Vega) | 9 | 5 | 2 | 5 | 0 | **21** |
| Chase (Valerian) | 11 | 4 | 1 | 2 | 0 | **18** |
| Taylor (DM) | 2 | 0 | 0 | 9 | 2 | **13** |
| Doug (Barrett) | 2 | 0 | 0 | 2 | 0 | **4** |
| Josh (Samothy) | 0 | 0 | 1 | 1 | 0 | **2** |
| Madi · Christie · Jill | 0 | 0 | 0 | 0 | 0 | **0** |

**Session champion: Taylor (Vega), 21 — the first non-Chase solo champion of the campaign.**

## S07 — The Sun Shard (04/20/2026) *(backfilled 06/06/2026)*

| Speaker | fuck | shit | bitch | damn/goddamn | motherfucker | Session Total |
|---|---|---|---|---|---|---|
| Taylor (DM) | 9 | 4 | 0 | 5 | 0 | **18** |
| Taylor (Vega) | 9 | 5 | 1 | 2 | 1 | **18** |
| Chase (Valerian) | 7 | 3 | 4 | 1 | 0 | **15** |
| Doug (Barrett) | 3 | 1 | 2 | 0 | 0 | **6** |
| Madi (Deanna) | 1 | 4 | 0 | 0 | 0 | **5** |
| Josh (Samothy) | 2 | 0 | 0 | 1 | 0 | **3** |
| Christie · Jill | 0 | 0 | 0 | 0 | 0 | **0** |

**Session champions (tie):** both Taylors, 18 each.

## S08 — Silence in the Library (05/04/2026)

| Speaker | fuck | shit | bitch | damn/goddamn | motherfucker | Session Total |
|---|---|---|---|---|---|---|
| Chase (Valerian) | 15 | 8 | 10 | 7 | 0 | **40** |
| Taylor (Vega) | 14 | 12 | 5 | 2 | 0 | **33** |
| Taylor (DM) | 5 | 0 | 3 | 1 | 0 | **9** |
| Josh (Samothy) | 1 | 2 | 0 | 4 | 0 | **7** |
| Jill (Flux) | 0 | 1 | 0 | 1 | 0 | **2** |
| Doug (Barrett) | 1 | 0 | 0 | 0 | 0 | **1** |
| Madi (Deanna) | 1 | 0 | 0 | 0 | 0 | **1** |
| Christie (Zelda) | 0 | 0 | 0 | 0 | 0 | **0** |
