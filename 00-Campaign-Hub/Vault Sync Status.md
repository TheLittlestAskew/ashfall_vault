...
4. ⚑ **3 of 29 approved spell-check rows deliberately NOT applied** (the approved table itself marked each "do not apply without DM confirmation"): `Karlsteiner`→`Carl Senior` (45%), `Tinkt— er`→`Taint— er` (40%), Bobby's `master curator`→`master armorer` (35%).
