...
function sectionQuotes() {
  const quotes = [
    ...
    ["Deanna Smith-Wesson (Maddie)", "Funny", "Yo, short, dead, and ugly, what's your name?"],
    ["Deanna Smith-Wesson (Maddie)", "Funny", "The Lion, the Witch, and the Audacity of This Bitch to ask for help after this, right?"],
  ...
  return [
    ...
    filledTable([
      ...
      { cells: ["Maddie (Deanna)", "fuck (2) · shit (1) · bitch (1)", "4", "\"Fuck yeah, love a good armor class\""] },
...
function sectionArchivistNotes() {
  return [
    ...
    filledTable([
      ...
      { cells: ["Item name", "Samothy's parlor gun: \"Tanya\" (Maddie/Josh) vs \"Peter Pistol\" (Chase, praised by DM) — final name unconfirmed", "00:33:25", "OPEN"] },
