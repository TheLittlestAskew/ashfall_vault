...
date: 2026-06-15
roll-archive-date: 2026-06-15
campaign: Ashfall Britannia
party-level: 8→10
tags: [session-notes, ashfall, archive-unqueried]
---

# Session 10 — Never Truly Alone

> Title taken from the play itself — [[Vega Bloodroot]] reading the Beast Master lore aloud at 00:16:59: *"A Beast Master standing alone is vulnerable. A Beast Master with their thralls is Truly Never Alone, or Never Truly Alone."* Alternates considered are logged in Quotes & Language.
> ⚠ **The DDB roll archive was NOT queried** — the Supabase MCP permission was not granted in this automated run. The Full Roll Log below is **transcript-only and un-cross-referenced**. See Archivist Notes ⚑.
...
| **Session Number** | 10 |
| **Session Date** | 06/15/2026 (73 min recording · **0 archive rolls cross-referenced** ⚑) |
| **Location** | [[The Grand Library of the Veiled Dawn]] — restricted section (start **and** end) |
| **Start Location** | [[The Grand Library of the Veiled Dawn]] — restricted section, mid-combat (direct continuation of [[Session 09 — The Battle of the Veiled Dawn (PARTIAL RECORDING)\|Session 09]]) |
| **End Location** | [[The Grand Library of the Veiled Dawn]] — restricted section; party camps overnight inside [[Zelda Z Whipper\|Zelda]]'s Tiny Hut |
...
| **Party Level** | 8 → **10** (single award; DM also switched XP → milestone "from here on out") ⚑ |
| **Total Rolls Logged** | ~90 roll events reconstructed from transcript · **0 verified against `ashfall_session_rolls`** ⚑ |
| **Spelling Checked** | Yes — `061526_Spell_Check_Log.md` (26 of 29 approved rows applied) |
| **Corrected Transcript** | `Session_Sources/Transcripts/Corrected/10_061526_corrected.md` |
...
**The aftermath.** "What was a nice semi-clean library is now coated in the blood of many, many cultists." Flux has been filling the bag of holding with the restricted section's books and scrolls the entire fight, plus diamonds, rubies and emeralds — and takes a **jade ball resting in the mouth of a big-cat skull**. Identify returns **no magic**: it's a plain skull, jaguar-like in stature but built like a tiger, four fangs on the bottom and two on top, from an animal *"at one point abundant in the area,"* **severed at the neck**. Valerian loots the Beast Master's ashes for **200 gold across all the bodies** and a **folded note in an unreadable, near-hieroglyphic script**, which he pockets to see if anyone can decipher it.

**The whisper.** The DM asks Flux for a Perception check "for no particular reason," Flux has advantage and rolls **22** — and hears whispering to his left. Nothing there. He turns back to the party and hears it again, clearer: **it is saying his name.** He doesn't know where it's coming from. Samothy's contribution is "Don't go into the light." Flux ignores it: "If it keeps happening, then I'll worry about it."

**Level 10, milestone, and an early night.** The DM awards enough XP to reach **level 10** — a two-level jump from S09's confirmed level 8 ⚑ — and confirms the campaign is on **milestone from here on out**. Long rest granted; the party camps in the library and Zelda ritual-casts Tiny Hut. Next session opens **in the castle**. Barrett gets a house ruling on **automatic weapons** ("it should be fine for automatics"), Samothy picks up a teleport infusion, Vega calls Relentless Rage ⚑, and everyone's custom weapons are waiting at **[[Bobby]]'s** to be collected next session. The session ends at 73 minutes on player exhaustion rather than a story beat — "You guys, I'm so tired" / "I'm sorry, guys, I gotta work" — with Vega calling it: "This is a good stopping place."

### Session Setting

Opens **mid-combat, mid-round**, with no recap: the second half of an enemy attack roll against [[Barrett Grimmskar]]. The party is spread vertically across the multi-floor restricted section of [[The Grand Library of the Veiled Dawn]], the fight begun in [[Session 09 — The Battle of the Veiled Dawn (PARTIAL RECORDING)|S09]] still in progress. **In-game days since the beginning of the story:** [Unknown/Ambiguous] — never stated. **In-game time:** [Unknown/Ambiguous]; the session closes with a granted long rest and the party camping "here for the night."

### Locations Visited

| Location | Description | Notable Details |
|---|---|---|
| [[The Grand Library of the Veiled Dawn]] — **restricted section** (only location this session) | Multi-floor cult-run knowledge vault; the session never leaves it | Open landings with a **banister** you can see and spit down over; **climbable bookcases** ([[Flux]] fights from on top of them); **book stacks** deep enough to hide a spider; a **railing** Samothy shoots over; staircases connecting floors, one of them the party's chokepoint |
| — floor height | Ruled on the record | Player assumed "standard 12-foot floors"; **DM: "10-foot floor."** |
| — post-battle state | | "What was a nice semi-clean library is now coated in the blood of many, many cultists"; the Beast Master's body reduced to ash |
| [[The Walled Base (Museum-Castle)]] ("the castle") | **Not visited** — next session's opening location | DM: "when we pick up again, you guys will be in the castle" |
| [[Bobby]]'s forge | **Not visited** — referenced twice | Vega directed there for a warhammer; the party's custom weapons are waiting there for next session |
...
- **00:55–00:57** — **Vega kills Cuck** (19 → 13, Reckless 26 → 18; 33 for the round). Last enemy standing. "He lives, but he dies." Vega spits on the body.
- **00:57** — **Level-up to 10** awarded; XP → **milestone** confirmed.
- **00:58–00:59** — DM collects Zelda's passive perception (19). Table drifts.
- **00:59–01:03** — **Looting.** Books, scrolls, diamonds, rubies, emeralds. The **jade ball in the big-cat skull** — Flux takes the whole thing, then **Identifies** it: no magic, severed at the neck, an animal once abundant in the area.
- **01:03–01:04** — Valerian loots the Beast Master's ashes: **200 gold** total and the **folded, unreadable note**. Vega asks about a warhammer and is pointed at **[[Bobby]]**.
- **01:04–01:06** — **Flux's Perception 22 (advantage)** → he hears his own name whispered, twice, from nowhere. He chooses to ignore it.
- **01:06–01:12** — Long rest granted; camp in the library; Zelda ritual-casts **Tiny Hut**. Level-10 shopping talk, the **automatic weapons** house ruling, Bobby's weapons flagged for next session, and an early close on player fatigue.
...
- ⚔️ **RESOLVED (This Session): the Grand Library battle.** The S08 cliffhanger / S09 combat is over. Party victorious, no PC downed on the record.
- ✅ **RESOLVED (This Session): the Beast Master.** Killed by [[Valerian Hellebore]]'s Call Lightning; body reduced to ash. ⚑ Never spoke, never named, never parleyed with — no interrogation happened, and Valerian says so out loud.
...
- 🔨 **NEW — Bobby's armory run.** Every PC has a custom weapon waiting at [[Bobby]]'s to collect next session; [[Barrett Grimmskar]] has a green light on **automatic weapons**; [[Vega Bloodroot]] is shopping for a **warhammer**.
- 📚 **CARRYOVER — the restricted-section haul.** [[Flux]]'s bag of holding now contains the entire restricted section's books and scrolls. **None have been read.** This is the material the party came for (relic / Sun Shard lore) and nobody has opened any of it.
- ⛪ **CARRYOVER — [[Cult of the Pale World]].** The dead are named as "cultists" by the DM; Aloysius, Gregory, the Watch Captain and the murder-cardinal are all still unaccounted for.
- 📈 **OPEN — the level 8 → 10 jump** and the XP→milestone switch. ⚑ Possible unrecorded session between 05/11 and 06/15 (see Archivist Notes).

## Character Activity

### Party Structure & Subgroups

The party never formally splits — but it is **spread vertically across three floors** for most of the fight, with line of sight and stair access as the recurring constraint.
...
|---|---|---|---|---|---|
| **The Beast Master** ⚑ NEW (unnamed) | Vampire — **Beast Master** (psychic beast-thrall controller) | Presumed [[Cult of the Pale World]] ⚑ — never stated | Killed by [[Valerian Hellebore]]'s Call Lightning; never spoke a line | [[The Grand Library of the Veiled Dawn]], lower floor | **Dead** — body reduced to ash; looted for 200gp (party total) and the folded note |
| [[Mr. Cat\|Mr. Cat, Esquire]] | Steel Defender (construct) — [[Samothy Smith-Wesson]]'s | The party | Imposed disadvantage on Taint's hit and saved [[Barrett Grimmskar]]; missed Taint (12) | [[The Grand Library of the Veiled Dawn]], beside Samothy | **Active** |
| [[Bobby]] | Dwarf — master armorer (glossary, S02) | Allied smith | Referenced only. DM: "I would talk to Bobby. Bobby's a master **curator** at this point" ⚑ *(word left uncorrected — 35% confidence, see spell-check log)*. Holds every PC's custom weapon | Off-screen | **Alive**, off-screen; set up as a next-session hook |
| **Carl Jr.** | Enemy token (deceased before this session) | — | Referenced only: "He's about to be reunited with Carl Jr." | — | **Dead** (prior session) ⚑ possibly = S09's "Carl A"/"Carl B" |
...
- **Party ↔ [[Bobby]]:** deepening. He's now the default answer to "where do I get a weapon," is crafting on request (including a green-lit automatic), and is holding seven custom weapons for pickup.
- **Party ↔ the DM (table-level):** the DM grants the level-up, the milestone switch, the long rest, and the automatic-weapons ruling in a single ten-minute stretch — a notably generous close.

## Artifacts — Loot & Items

| Character/Owner | Item/Artifact | State/Context |
|---|---|---|
| [[Flux]] | **Books and scrolls of the restricted section** (bag of holding) | Gathered across two full turns *during* combat plus the aftermath — "anything I can get my hands on." **None read yet.** This is the relic/Sun Shard lore the party came for. |
| [[Flux]] | **Diamonds, rubies, emeralds** | From the restricted section; quantity and value unstated ⚑ |
| [[Flux]] | **Jade ball (~1 lb) seated in a big-cat skull** | Took the whole assembly ("You can't separate the set"). **Identify: no magic** — "just a plain skull." Jaguar-like stature, tiger-like musculature, 4 fangs below / 2 above, **severed at the neck**; species unknown but "at one point this animal was abundant in the area." |
| [[Valerian Hellebore]] | **Folded note in an unknown script** | Looted from the Beast Master's ashes. "It's in a language you can't understand, so it's like hieroglyphics almost." Kept expressly to find someone who can decipher it. |
| Party (unassigned) | **200 gold** | Total across **all** bodies, not per body |
| [[Vega Bloodroot]] | **Eldritch Claw Tattoo** | Used twice this session (+6 damage each), after explicitly noting she forgot it last session |
| [[Barrett Grimmskar]] | **Risk Dice (1d8)** — Gunslinger | Spent one on **Skin of Your Teeth**; insufficient to raise AC above the incoming 22 |
| [[Vega Bloodroot]] | **Warhammer** — *not acquired* | Requested from the DM; directed to [[Bobby]] |
...
> ⚠ **No initiative was rolled this session.** The combat carries over from S09, so no d20s exist for it. The order below is **inferred from the DM's turn calls**, per the initiative rule in the project instructions. Opportunity attacks are not treated as order changes.
...
| [[Mr. Cat\|Mr. Cat, Esquire]] | n/a — acts on Samothy's turn | 5b (DM initially gave him his own slot; Samothy corrected it) |
| [[Valerian Hellebore]] | [Unknown/Ambiguous] | **6** ("it's the spider's turn") |
| [[Deanna Smith-Wesson]] | [Unknown/Ambiguous] | **7** ("after the spider, it's Deanna") |
| [[Flux]] | [Unknown/Ambiguous] | **8** |
| Carl Senior | [Unknown/Ambiguous] | 9 (enemy) |
...
The party wins decisively and pays almost nothing for it. Across ~57 minutes of play the only damage taken by a PC on the record is **Vega: 6 + 9 = 15**, and Barrett's one guaranteed hit is negated by Mr. Cat. No healing was cast, no death saves were rolled, no PC was downed, and no resources beyond one Risk Die and a handful of spell slots are noted as spent.
...
> ⚠ **Source: transcript only.** The `ashfall_session_rolls` view was **not queried** — the Supabase MCP permission was not granted in this automated run — so **none** of the values below have been verified against the DDB archive, and no archive-only rolls (quick mechanical rolls that never got spoken aloud) are represented. Every row is `transcript-only` pending a re-run. Rolls the DM made for enemies are attributed to the DM-controlled creature.

| Character/NPC | Roll/Check | Result | Context / Outcome |
|---|---|---|---|
| Enemy (unnamed) | Attack (2nd) | 18 | Misses [[Barrett Grimmskar]]. Session opens on this roll. |
| [[Samothy Smith-Wesson]] | Attack vs Lucky (advantage, Vex) | 12 | Miss |
...
| [[Vega Bloodroot]] | Attack vs Cuck | 15 | Hit |
| [[Vega Bloodroot]] | Damage | 15 | — |
| [[Vega Bloodroot]] | Attack vs Cuck | 17 | Hit |
| [[Vega Bloodroot]] | Damage | 15 | **30 for the turn** |
| [[Barrett Grimmskar]] | Attack vs "the tank" | 26 | Hit |
| [[Barrett Grimmskar]] | Damage | 19 | "Jesus Christ, superstar!" |
| [[Barrett Grimmskar]] | Attack (2nd shot) | 16 | Hit |
| [[Barrett Grimmskar]] | Damage | 10 | Then falls back to the party |
...
| Cuck (DM) | Damage | 6 | — |
| Taint (DM) | Attack vs Barrett | 22 | Hit — exactly meets AC 22 ("if you meet AC, you beat AC") |
...
| [[Samothy Smith-Wesson]] | Damage | **34** (4d6 = 24, +10) | **Lucky dies.** "Finger Guns for the win!" |
| [[Mr. Cat\|Mr. Cat]] | Attack vs Taint (+7) | 12 | Miss |
...
| [[Flux]] | Damage | 7 + 15 = **22** | **Shirley dies.** ⚑ Flux asks "Are *they* within 5 feet of Zelda?" then "I hit the right one" — Shirley may be a pair |
| [[Flux]] | Finger Guns vs Taint (bonus action) | 14 | Hit |
| [[Flux]] | Damage | 7 | — |
| Enemy (DM) | Wisdom save | Failed | Target unstated |
| [[Vega Bloodroot]] | Attack | 30 / 20 ⚑ garbled | Hit |
| [[Vega Bloodroot]] | Damage | 16 | — |
| [[Vega Bloodroot]] | **Eldritch Claw Tattoo** rider | +6 | → 22. "I didn't use tattoo damage at all last time" |
| [[Vega Bloodroot]] | Attack — **Reckless** (declared) | 27 | Hit |
| [[Vega Bloodroot]] | Damage | 14 (+6 tattoo) | **42 for the round** |
| [[Barrett Grimmskar]] | Attack vs Taint | 17 | Hit |
...
| [[Deanna Smith-Wesson]] | Damage | 14 | "That's my turn." |
| ⚑ Unattributed | **Con save** | 15 | DM: "I gotta look at my notes real quick for no particular reason… can I get a con save from you?" **Target never named.** Answered by the speaker mapped to Samothy. Consequence never revealed. |
| [[Vega Bloodroot]] | Attack | 19 | Hit |
| [[Vega Bloodroot]] | Damage | 10 + 3 = 13 | — |
| [[Vega Bloodroot]] | Attack — **Reckless** | 26 | Hit |
| [[Vega Bloodroot]] | Damage | 18 (33 for the round incl. +2) | **CUCK DIES — last enemy standing.** "He lives, but he dies." |
| [[Zelda Z Whipper\|Zelda]] | Passive Perception | **19** | Stated, not rolled; DM asked for it and never said why ⚑ |
| [[Flux]] | **Perception (advantage)** | **22** | Hears whispering, then **his own name**, from an empty space. Twice. |
...
> Out-of-character / above-table lines are marked **→** and should be excluded from public-facing display per the tracker convention. ⚑ Speaker attribution rests on the **unconfirmed** diarization map — see Archivist Notes.

| Speaker | Quote | Tag |
|---|---|---|
| Taylor (DM) | "Um, I'll have you know Lucky's a girl and you're not supposed to hit girls." | DM quip |
| [[Samothy Smith-Wesson]] | "Hey, equal rights and equal lefts, man." | Funny |
| [[Vega Bloodroot]] | "Luck be a lady tonight." | Funny |
| [[Valerian Hellebore]] | "That was not a good roll. 6 lightning damage. Out of a possible 40. That was 2 2s and 2 1s. I'm crying. I didn't even know spiders could cry." | Funny |
| [[Barrett Grimmskar]] | "Oh no, it's a sad vampire boy." | Funny |
| [[Barrett Grimmskar]] | "Then cut to 30 minutes later where he just rips Barrett apart." | Funny |
| Taylor (DM) | "Well, that's what the Beast Masters look like— very weak and frail." | Important to story |
| Taylor (DM) | "No, it's not Edward. He doesn't sparkle." | DM quip |
| [[Barrett Grimmskar]] | "He just gets really ashy in the sunlight." | Funny |
| [[Vega Bloodroot]] | "I'm gonna let everybody know that there's a skinny twink downstairs who is, I think, coming after us." | Funny |
| [[Vega Bloodroot]] | "A Beast Master standing alone is vulnerable. A Beast Master with their thralls is Truly Never Alone, or Never Truly Alone." | **Important to story** *(read aloud from the DM's lore; the speaker's own verbatim self-correction is preserved)* |
| [[Vega Bloodroot]] | "He's probably got friends nearby, so we need to GTFO." | Serious |
| [[Samothy Smith-Wesson]] | "Mr. Cat for the rescue!" | Funny |
| [[Barrett Grimmskar]] | "Thank you, Mr. Cat." | Poignant |
| [[Samothy Smith-Wesson]] | "Damn, I am fucking this guy up." | Funny |
| [[Valerian Hellebore]] | "I'm one of the few people that can reach him, so fuck it, we ball." | Serious |
| [[Valerian Hellebore]] | "I feel like we probably should have interrogated him. You're just here for the bookshelf? Because 2024 rules, I can talk, bitches." | Funny |
| [[Vega Bloodroot]] | "Are you a black widow? Because you're taking him for everything he's got." | Funny |
...
| [[Barrett Grimmskar]] | "There's some of us that keep forgetting that we have shit that we can do every fucking turn, like me forgetting that I have Savage Attacker and, uh, my new feat Piercer to reroll shitty damage." | → above-table |
| [[Valerian Hellebore]] | "Have you tried not having so many options?" | Banter |
| [[Barrett Grimmskar]] | "But then, but then I don't have shit I can do." | Banter |
| [[Barrett Grimmskar]] | "He lives, but he dies." | **Funny** — the session's most-quoted line, echoed by Valerian |
| [[Vega Bloodroot]] | "Cuck dies and there's nobody there to see it. I spit on him." | **Poignant / funny** |
| [[Barrett Grimmskar]] | "He enjoys that." / [[Vega Bloodroot]] "He does, but he's too dead to enjoy it right now." | Banter |
| Taylor (DM) | "What was a nice semi-clean library is now coated in the blood of many, many cultists." | **Serious** |
| [[Flux]] | "Um, the way that you said that, no, but I'm going to." | Funny |
| [[Barrett Grimmskar]] | "You can't separate the set." | Funny |
| [[Vega Bloodroot]] | "Thralls. Beast Master go bye-bye?" | Funny |
| Taylor (DM) | "you don't know what animal it is, but you do know that at one point this animal was abundant in the area." | **Important to story** |
| Taylor (DM) | "on the back of the skull where the neck would meet the spine, you can see where it was severed." | **Important to story** |
| [[Vega Bloodroot]] | "Vega gonna look at it and be like, just looks like pictures to me. Maybe he just likes to draw." | Funny |
| Taylor (DM) | "you hear it again. This time you hear it more clear and it's saying your name. But you don't know where it's coming from." | **Important to story** |
| [[Flux]] | "I ask Samothy, you hear that? Someone's saying my name." | Serious |
| [[Samothy Smith-Wesson]] | "Don't go into the light." | Funny |
| [[Flux]] | "If it keeps happening, then I'll worry about it." | Serious |
| Taylor (DM) | "when we pick up again, you guys will be in the castle." | **Important to story** |
| [[Vega Bloodroot]] | "I thought we were going milestone." / Taylor (DM) "Yep, from here on out." | → above-table |
| [[Vega Bloodroot]] | "Everything's over now, and all that's left is you in the infinite void." | → above-table *(quoting Lumalee, Super Mario Bros. Wonder)* |
| [[Vega Bloodroot]] | "This is a good stopping place." | → above-table |

### Profanity Record

> ⚑ Attribution rests on the **unconfirmed** speaker map. Counts are from the corrected transcript.
...
| [[Valerian Hellebore]] | shit | 3 | Forgetting the Beast Master's entrance; "zap the shit out of"; the stubbed toe |
| [[Valerian Hellebore]] | bitch / bitches | 2 | "that was a feral bitch"; "2024 rules, I can talk, bitches" |
| [[Barrett Grimmskar]] | shit | 4 | 19-damage surprise; the failed Risk Die; the forgotten-features vent (×2) |
| [[Barrett Grimmskar]] | damn | 2 | Valerian's Call Lightning; "It's about damn time" (killing Taint) |
| [[Barrett Grimmskar]] | fuck / fucking | 2 | The insufficient Risk Die; "every fucking turn" |
| [[Barrett Grimmskar]] | shitty | 1 | "Piercer to reroll shitty damage" |
| [[Samothy Smith-Wesson]] | damn | 3 | Rolling a 12 with advantage (×2); "Damn, I am fucking this guy up" |
| [[Samothy Smith-Wesson]] | fucking | 2 | Mid-crit-streak; "fucking up her friends" |
| [[Samothy Smith-Wesson]] | ass | 1 | "crazy-ass movement" (the new teleport infusion) |
| Taylor (DM) | damn | 3 | "Oh damn, how about a 16?"; "Jesus damn, these dice"; Shirley's save |
| Taylor (DM) | fucking | 1 | "those dice are pretty fucking cool" |
| Taylor (DM) | shit | 1 | "Our dogs lay on our shit all the time" |
...
| Style | Title | Source |
|---|---|---|
| Humorous | **He Lives, But He Dies** | Barrett, 00:56:50, echoed by Valerian |
| Dramatic | **Someone's Saying My Name** | Flux, 01:05:51 |
| Serious | **The Blood of Many, Many Cultists** | DM, 00:59:19 |
| Straightforward | **The Beast Master Falls** | Descriptive |
| Quote-based | **Nobody There to See It** | Vega, 00:57:00 |
| *(also weighed)* | *Mr. Cat for the Rescue* · *A Sad Vampire Boy* · *Truly Never Alone* | Samothy 00:28:11 · Barrett 00:07:00 · Vega 00:16:59 |

**FINAL CHOSEN TITLE: *Never Truly Alone*** — [[Vega Bloodroot]]'s verbatim rendering of the Beast Master lore at 00:16:59. It carries the session's only real worldbuilding drop, describes the manner of the Beast Master's death (he came up the stairs alone and died for it), and lands on the night's open hook — Flux hearing a voice that isn't there. ⚑ The speaker says both orderings in the same breath ("Truly Never Alone, or Never Truly Alone"); the second was chosen. If the DM's written lore uses the other, retitle.

## Archivist Notes

- ⚑ **THE DDB ROLL ARCHIVE WAS NOT QUERIED — THIS IS THE BIGGEST GAP IN THIS NOTE.** Both required queries (`SELECT * FROM ashfall_session_rolls WHERE session_date = '2026-06-15'` and `SELECT MAX(timestamp_iso) FROM ashfall_session_rolls`) failed: the Supabase MCP permission was not granted in this non-interactive run, on both the `supabase` and `supabase-account2` servers, and no local Supabase credentials exist to route around it (`.env` holds only `DDB_COBALT`). **No sync-gap determination was possible — that check is outstanding, not passed.** The Full Roll Log is transcript-only and un-cross-referenced: archive-only rolls are missing entirely, no roll totals or individual die values are verified, and no null-character rolls were resolved by `user_id` because none were retrieved. **Re-run Step 4 in an interactive session and reconcile before the Roll Statistics tracker is updated.**
- ⚑ **Level 8 → 10 in a single award.** S09 (05/11/2026) confirmed the party reaching **level 8**; here the DM awards "enough XP for you guys to level up to **level 10**," and Zelda's "at level 8 or level 10?" confirms she read it the same way. Combined with the **35-day gap** since S09 and no intervening recording on disk, this may indicate an **unrecorded session** — the same shape as S04.5. **Do not create an S09.5 stub without confirmation**, and note that if such a session exists, this session's number is wrong.
- ⚑ **XP → milestone, house-rule change.** DM: "Yep, from here on out." For `House Rules & Rulings.md`.
...
- ⚑ **Still awaiting DM confirmation** (collected in [[DM Questions — Open]]): **Karlsteiner** (named twice at 00:03, never again — real enemy or ASR artifact?), **Skin of Your Teeth** (Gunslinger maneuver, quoted in full at 00:26:05), and **Beast Master** as an individual rather than a class. *(Lucky's she/he inconsistency was reviewed and dropped — Taylor ruled it doesn't matter.)*
...
- ⚑ **Site parser dependencies.** This note supplies the Metadata / Summary / Threads / NPCs / Archivist Notes panels. The **Hero, Quotes, Loot and Profanity** panels come from four *other* files keyed by session number and must be written in Convo 2: a `- **S10 …` bullet in `Vega Bloodroot.md` → `## Key Events`, and `## S10` blocks in `Quote Board S01-S10.md`, `Loot Tracker S01-S10.md` and `Profanity Ledger S01-S10.md`. **S10 is the last session in the S01-S10 tracker range** — the next session starts a new tracker file set.
- **Pattern — vertical battlefield control.** The party's winning shape this session was elevation and separation: Flux on the bookcases, Samothy over the railing, Zelda at the banister, Valerian descending as a spider, Vega and Barrett corking the stairwell. Line of sight, not damage, was the limiting resource — four separate turns open with a sightline question to the DM.
- **Pattern — the scout advantage.** Vega's natural-20 Perception surfaced the Beast Master a full round before he could act, and Valerian killed him before he took a single turn. The session's principal threat never functioned.
- **Pattern — nobody reads the loot.** Three sessions running, the party acquires text (five books in S08, the restricted section in S09–S10, now an untranslatable note) and reads none of it. The bag of holding is becoming the campaign's biggest unopened box.
- **Table culture:** enemy names remain table-christened joke names in the S09 tradition; kill-credit is now an openly-negotiated social currency; and the DM's habit of asking for a check "for no particular reason" is now a recognized tell — the table laughed at it before Flux even rolled.
- **Unusual circumstances:** 73-minute session (short — S08 ran 149 minutes); cold open with no recap; all 7 players present; ends on player fatigue rather than a story beat; roughly 40% of the runtime after the last enemy dies is loot, level-up admin and out-of-character conversation.
