...
date: 2026-03-04
roll-archive-date: 2026-03-03
campaign: Ashfall Britannia
party-level: 6
tags: [session-notes, ashfall]
---

# Session 04 — A Gust of Wind

> Title **auto-selected** (Event) per Taylor's standing order — change anytime. Resolves the [[Session 03 — Mr. Cat, Esquire]] cliffhanger.

## Metadata

| | |
|---|---|
| **Session Date** | 03/04/2026 (rolls keyed 2026-03-03; 8:28–10:21 PM ET) |
...
> See [[Vega Bloodroot Journal]] — "The hospital. After."

## Summary

The 2F brawl **concluded** — 12 enemies total across S03–S04. Kills this session: Barrett (crit "Gut Shot" ⚑ name), [[Flux]] (nat-20 **Spellfire Flare** ⚑ one-shot), [[Samothy Smith-Wesson]] (bullet to the head), [[Deanna Smith-Wesson]] (one-shot Beast A, run by substitute-DM Madi), [[Valerian Hellebore]] (38-damage Moonbeam on a crit-failed save), and **[[Vega Bloodroot]]'s FIRST KILL of the campaign** — "Chance! Hooray! I did it!"

The loot sweep delivered the campaign's biggest haul:
- **THE OBSCURE BOOK** — found by Samothy in a barrel of medical textbooks; opening it sent a **gust of wind through the entire floor**. Presumed = [[Bobby]]'s commission ⚑. In the bag of holding.
- **Gems:** ~7 emeralds (anti-Beastmaster ammo), ~6 rubies, 1 diamond, 4 amethysts, ~25 gp.
- **Two ancient ritual daggers** ⚑: sweet-wood hilt w/ arcane **FIRE** engravings (Flux's find) · smoky-wood hilt w/ religious **WATER-deity** text (Deanna's find). Different woods + metals → smithy; Comprehend Languages planned.
- **Watermark paper** (Flux) — blank until candle-heated; faint unreadable lettering ⚑.
- Shipping orders: the medicine (potions, insulin, terminal-care meds) is **stored in the basement**.
- The **"Gary" photo** — woman + child, ~2 weeks pre-ash, with a love letter. Left in place.

Comedy of the sweep: Valerian + Zelda declared a room empty that Deanna + Barrett (via Barrett's newly revealed **Maverick Spirit** — Risk Die on failed INT/WIS/CHA checks) found full of gems. *"Sorry, is there a window in this room that I can throw my horrible druid ass self out of?"*

**New DM mechanic (tested, loved):** mid-multi-session-encounter spell recovery — each caster rolls 2d6+1d4 (Val & Deanna: all slots; Zelda & Flux: half; Samothy & Barrett: 3; Bardic: half).
