...
> [[Samothy Smith-Wesson]]'s Steel Defender, named in [[Session 03 — Mr. Cat, Esquire]] (the session is named after him).

| | |
|---|---|
| **Nature** | Steel Defender construct — "technically just a metal construct to look like a cat" / "just a really big house cat" |
| **Aliases** | Mr. Cat · Mr. Cat, Esquire · the kitty-taur (S01) · "Boots" (proposed, rejected) |
| **Stats (observed)** | +7 to hit (lvl-5), 1d8+3 force rend; 40 ft speed; Deflect Attack reaction |
| **Status** | Active companion; dormant between summons (house rule) |

## Profile

Summoned via Samothy's smith's tools (S01 house rule). Crossed from equipment to **beloved party member** in S03: named at the table, future cosmetics planned — **tuxedo paint job with a white monocle marking** around one eye ("distinguished gentleman… indubitably so"). Madi(⚑ attribution pending) pledged the name to a future real-world cat, husband-approved.
...
- **S11:** ⚔️ **HIS FIRST CONFIRMED KILL SINCE S01 — he finished Beast Thrall B.** After [[Samothy Smith-Wesson]] held the thrall grappled for three rounds, Mr. Cat landed the last hit (18 → **8**, 1d8+4) and [[Samothy Smith-Wesson]] called it: *"Oh nice, Cat finishes him off."* He'd missed three times getting there (14, 11, and 11 with advantage on a prone target). **Took his worst hit yet** — Thrall B broke the grapple and put a "dirty 20" into him for **13**, leaving him at roughly **one third**. ⚑ One of his attacks was resolved by **adding both advantage d20s** (17 + 8 = "25 to hit"); advantage takes the higher die, and the DM accepted the 25. Recorded, not corrected. **The beat that matters isn't mechanical:** [[Vega Bloodroot]]'s entire downtime declaration — the only one at the table that isn't about equipment — is *"cultivate her relationship with Mr. Cat"* / *"She just wants to pet him a lot."* **Third consecutive session in which the Steel Defender is treated as a member of the party rather than a tool**, and the first in which someone plans to do something for *him*.
